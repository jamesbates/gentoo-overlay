...
PATCHES=(
	"${FILESDIR}"/eqmod-checklimits-${PV}.patch
)
...
IUSE="
	...
	indi_drivers_orion_ssg3
	indi_drivers_playerone
	indi_drivers_pentax
	indi_drivers_qhy
	indi_drivers_qsi
	...
	indi_drivers_starbook_ten
	indi_drivers_sv305
	indi_drivers_sx
	indi_drivers_talon6
	indi_drivers_toupbase
	indi_drivers_webcam
	indi_drivers_weewx_json
"
...
DEPEND="
	...
	indi_drivers_playerone? ( sci-libs/indilib-3rdparty-libs[indi_drivers_playerone] )
